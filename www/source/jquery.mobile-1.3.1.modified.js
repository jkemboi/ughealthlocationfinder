...
function fixedPosition() {
	var w = window,
		...
		wkmatch = ua.match( /AndroidWebKit\/([0-9]+)/ ),
	...
	if(
		...
		( ( platform.indexOf( "Android" ) > -1 || platform.indexOf( "Android" ) > -1  || platform.indexOf( "Android" ) > -1 ) && wkversion && wkversion < 534 ) ||
		// Opera Mini
...
$.widget( "mobile.slider", $.mobile.widget, $.extend( {
	...
	_create: function() {
		...
		$.extend( this, {
			...
			beforeStart: null,
			userModified: false,
			//MOBILE-FUSION-TABLES: prevent stack overflow
			ignoreRefresh: false,
			mouseMoved: false
		});
